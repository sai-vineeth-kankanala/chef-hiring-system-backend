...
const AdminProfile = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      ...
      const delay = new Promise((resolve) => setTimeout(resolve, 1500)); // Simulated loading

      try {
        const [res] = await Promise.all([
          axios.get(`http://localhost:3000/admin/profile/${adminId}`, {
    ...
    <>
      ...
      <div className="jobseekerprofile-container">
        <div className="jobseekerprofile-card">
          ...
          <h4 className="jobseekerprofile-title">Admin</h4>
          ...
          <div className="jobseekerprofile-resetpwd-block">
            <button
              ...
              onClick={() => {
                navigate(`/reset/password/${profile.AdminID}`);
              }}
            >
