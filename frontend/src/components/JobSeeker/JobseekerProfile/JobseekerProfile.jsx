...
const JobseekerProfile = () => {
    ...
    const fetchProfile = async () => {
      ...
      try {
        const [res] = await Promise.all([
          axios.get(`http://localhost:3000/jobseeker/profile/${userId}`, {
  ...
  const handleEdit = () => {
    navigate("/jobseeker/edit-profile"); // <-- Adjust the route as needed
  };
    ...
    <>
      ...
      <div className="jobseekerprofile-container">
        <div className="jobseekerprofile-card">
          ...
          <h4 className="jobseekerprofile-title">Job Seeker</h4>
          <div className="jobseekerprofile-details">
            ...
            <p className="jobseekerprofile-p">
              <strong className="jobseekerprofile-label">Date of Birth:</strong>{" "}
              {new Date(
                new Date(profile.DateOfBirth).setDate(
            ...
            <p className="jobseekerprofile-p">
              <strong className="jobseekerprofile-label">Address:</strong>{" "}
              {profile.Address}
            </p>
            <p className="jobseekerprofile-p">
          ...
          <div className="jobseekerprofile-resetpwd-block">
            <button
              ...
              onClick={() => {
                navigate(`/reset/password/${profile.JobSeekerID}`);
              }}
            >
