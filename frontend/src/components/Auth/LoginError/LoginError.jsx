...
import "./LoginError.css"; // Optional, for styling
      ...
      <div className="loginerror-body">
        <div className="loginerror-container">
          ...
          <div className="error-content">
            <h1 className="login-error-h1">Login Expired or Unauthorized</h1>
            <p className="login-error-p">Please log in again to continue.</p>
            <button
